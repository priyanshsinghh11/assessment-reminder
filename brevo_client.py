...
from config import (BREVO_API_KEY, BREVO_SENDER_NAME, BREVO_SENDER_EMAIL,
                    EMAIL_LOGO_URL)
...
def build_reminder_email(
    ...
    return {
        "subject": subject,
        "html": _build_html(first, role_title, assessment_url),
        ...
        "text": _build_text(first, role_title, assessment_url),
    }
...
def send_reminder_email(
    ...
    """
    email = build_reminder_email(to_name, role_title, assessment_url, reminder_number)
...
def _build_text(name: str, role_title: str, assessment_url: str) -> str:
...
def _build_html(name: str, role_title: str, assessment_url: str) -> str:
