<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/69 -- AI-Native Full Stack Product Engineer v3. Regenerated by `manage.py ingest`; edit rubric-product-engineer.md instead. -->
