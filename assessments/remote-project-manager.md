<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/46 -- Project Management Assessment - Remote v1. Regenerated by ingest.py; edit rubric-remote-project-manager.md instead. -->
