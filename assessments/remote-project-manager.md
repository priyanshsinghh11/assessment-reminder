<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/46 -- Project Management Assessment - Remote v1. Regenerated by `manage.py ingest`; edit rubric-remote-project-manager.md instead. -->
