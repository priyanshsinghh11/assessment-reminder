<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/42 -- AI Native Designer v2. Regenerated by `manage.py ingest`; edit rubric-senior-ai-native-designer.md instead. -->
