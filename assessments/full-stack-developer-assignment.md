<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/31 -- AI-Native Full Stack Developer Assignment v2. Regenerated by `manage.py ingest`; edit rubric-full-stack-developer-assignment.md instead. -->
