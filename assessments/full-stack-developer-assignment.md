<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/31 -- AI-Native Full Stack Developer Assignment v2. Regenerated by ingest.py; edit rubric-full-stack-developer-assignment.md instead. -->
