<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/32 -- Core Assignment v3. Regenerated by `manage.py ingest`; edit rubric-technical-program-manager.md instead. -->
