<!-- Crawled from https://candidateassessments.ajaia.ai/admin/assignments/32 -- Core Assignment v3. Regenerated by ingest.py; edit rubric-technical-program-manager.md instead. -->
